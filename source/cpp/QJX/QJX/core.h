...
class Floq2SpinsCoreBehaviour : public CoreBehavior
{
public:
	virtual void init_splits(AllData* ad) const;
	virtual void free_splits(AllData* ad) const;
...
class FloqManySpinsCoreBehaviour : public CoreBehavior
{
public:
	virtual void init_splits(AllData* ad) const;
	virtual void free_splits(AllData* ad) const;
...
class FloqSpinPhCoreBehaviour : public CoreBehavior
{
public:
	virtual void init_splits(AllData* ad) const;
	virtual void free_splits(AllData* ad) const;
