...
void DimerSyncDebugBehaviour::save(AllData* ad) const
{
	save_hamiltonian_and_dissipation(ad);
}
...
void Floq2SpinsDebugBehaviour::save(AllData* ad) const
{
	RunParam* rp = ad->rp;
	ConfigParam* cp = ad->cp;
	MainData* md = ad->md;
...
void FloqManySpinsDebugBehaviour::save(AllData* ad) const
{
	RunParam* rp = ad->rp;
	ConfigParam* cp = ad->cp;
	MainData* md = ad->md;
...
void FloqSpinPhDebugBehaviour::save(AllData* ad) const
{
	RunParam* rp = ad->rp;
	ConfigParam* cp = ad->cp;
	MainData* md = ad->md;
