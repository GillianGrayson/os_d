...
void output_params(RunParam &rp, ConfigParam &cp)
{
	...
	cout << "int_is_dump_adr = " << cp.int_is_dump_adr << endl;

	cout << "num_periods_rate = " << cp.rate_num_periods << endl;
	cout << "rate_ampl_part = " << cp.rate_ampl_part << endl;
