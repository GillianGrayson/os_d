...
states = linspace(1, sys_size, sys_size) - 1;
...
savefig(sprintf('%s/rhonn_%s.fig', home_figures_path, suffix_save));

h=gcf;
set(h,'PaperOrientation','landscape');
set(h,'PaperUnits','normalized');
set(h,'PaperPosition', [0 0 1 1]);
print(gcf, '-dpdf', sprintf('%s/rhonn_%s.pdf', home_figures_path, suffix_save));
