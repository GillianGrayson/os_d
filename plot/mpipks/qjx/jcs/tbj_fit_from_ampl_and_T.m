...
title(h, 'decades');
set(gca,'YDir','normal');
savefig(sprintf('%s/tbj_decades_from_ampl_and_T_%s.fig', home_figures_path, suffix_save));

h=gcf;
set(h,'PaperOrientation','landscape');
set(h,'PaperUnits','normalized');
set(h,'PaperPosition', [0 0 1 1]);
print(gcf, '-dpdf', sprintf('%s/tbj_decades_from_ampl_and_T_%s.pdf', home_figures_path, suffix_save));
