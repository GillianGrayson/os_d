...
for W_id = 1:W_num
    ...
    for W_seed_id = 1 : W_seed_num
        ...
        for run_id = 1:num_runs
            ...
            path_to_folder = sprintf('%s/main_%d_%d_%d/lpn_%d_%0.4f_%0.4f_%0.4f/run_%d_%d_%d_%d/Nс_%d/obs_%d_%d_%d/rnd_%d_%d/diss_%d_%0.4f_%0.4f/prm_%0.4f_%0.4f_%0.4f/start_%d_%d/ss_%d', ...
				data_path, ...
				sys_id, ...
				task_id, ...
				prop_id, ...
