...
savefig(sprintf('%s/mult_lambda_and_observables_from_g_%s.fig', home_figures_path, suffix_save));

h=gcf;
set(h,'PaperOrientation','landscape');
set(h,'PaperUnits','normalized');
set(h,'PaperPosition', [0 0 1 1]);
print(gcf, '-dpdf', sprintf('%s/mult_lambda_and_observables_from_g_%s.pdf', home_figures_path, suffix_save));
